                        ...
                        <div className="col-12">
                            <div className="cta__wrapper">
                                ...
                                <div className="cta__desc">
                                    <p>Share your knowledge and inspire the next generation of tech professionals.
                                        Join us as an instructor and grow your career while teaching what you love.</p>
                                </div>
