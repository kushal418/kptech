                                ...
                                <div className="col-xl-5 col-lg-6">
                                    <div className="about__title-wrap">
                                        <div className="section__title">
                                            ...
                                            <h2 className="title tg-svg">From Learners to Leaders: <span className="position-relative"><span className="svg-icon" id="about-svg" data-svg-icon="assets/img/icons/title_shape.svg" />Our Story</span> </h2>
                                        </div>
                                        ...
                                        <p>At KP Technologies, we are passionate about empowering the next generation of tech professionals through high-quality, affordable, and practical IT education. Founded with a mission to bridge the gap between academic learning and real-world industry demands, we offer project-based training, live mentorship, and 100% placement assistance.</p>
                                        <p>We don’t just teach — we build careers. Our 3–6 month intensive programs are designed to simulate real workplace environments, complete with live projects, interview preparation, and internship opportunities. We also provide final year project guidance and help students turn their ideas into real products.</p>
